...
func _init_game():
	bubble_1._bubble_twist(1,0.02)
	bubble_2._bubble_twist(1,0.02)
	bubble_3._bubble_twist(1,0.02)
	await get_tree().create_timer(BaseSetting.move_time).timeout
	bubble_1._bubble_appear("HolidayBubble",bubble_end_location_1.position)
